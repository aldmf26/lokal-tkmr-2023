    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white"
            ...
            <div class="container">
                ...
                <div class="ml-2 d-flex align-items-center border rounded-pill p-1 bg-white shadow-sm"
                    style="gap: 5px; font-size: 0.8rem; font-weight: 700;"
                    title="Shortcut: O (Order), M (Meja), H (Head), B (Bar), L (Laporan)">
                    <span class="">Tekan Shortcut</span>
                    <span class="mx-2">O : Order, M : Meja, H : Head, B : Bar, L :
                        Laporan</span>
                </div>
        ...
        <!-- Modal Cek Bill -->
        <div class="modal fade" id="modalCekBill" tabindex="-1" role="dialog" aria-labelledby="modalCekBillLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable" role="document" style="max-width: 500px;">
                <div class="modal-content">
                    <div class="modal-header" style="background: #197dab; color: white;">
                        <h5 class="modal-title" id="modalCekBillLabel"><i class="fas fa-file-invoice"></i> Daftar Bill
                            Aktif</h5>
                    ...
                    <div class="p-3" style="border-bottom: 1px solid #dee2e6;">
                        <input type="text" id="searchBill" class="form-control"
                            placeholder="🔍 Cari meja, no invoice, atau distribusi..." autocomplete="off">
                    </div>
        ...
        <script>
            ...
            function renderBillList(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    var m = data[i];
                    html += '<a href="' + m.url +
                        '" target="_blank" class="list-group-item list-group-item-action" style="border-left: 4px solid #00A549; padding: 12px 15px;">';
