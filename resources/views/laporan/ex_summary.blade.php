    ...
    <div class="card">
        <div class="card-body">
            ...
            <table width="100%">
                ...
                <tr>
                    <td>order: <?= $count_dinein->total_order ?? 0 ?> menu: <?= $count_dinein->total_menu ?? 0 ?></td>
                    <td width="1%"></td>
                    <td></td>
                    <td style="text-align: right;"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="font-weight: bold;" width="1%">:</td>
                    <td></td>
                    <td style="text-align: right;font-weight: bold;"><?= number_format($total_ayce->total ?? 0, 0) ?>
                    </td>
                </tr>
                <tr>
                    <td>order: <?= $count_ayce->total_order ?? 0 ?> orang: <?= $count_ayce->total_orang ?? 0 ?></td>
                    <td width="1%"></td>
                    <td></td>
                    <td style="text-align: right;"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="1%">:</td>
                    <td></td>
                    <td style="text-align: right;"><?= number_format($pb1_ayce, 0) ?>
                    </td>
                </tr>
