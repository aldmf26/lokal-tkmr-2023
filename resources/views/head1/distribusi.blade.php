<ul class="nav nav-pills mb-3 custom-scrollbar-css" id="pills-tab" role="tablist">
    ...
    ?>
        <li class="nav-item">
            <?php if ($id == $d->id_distribusi) : ?>
                ...
                <?php else : ?>
                    <a href="<?= route('head', ['id' => $d->id_distribusi]) ?>" data-badge="<?= $d->jumlah ?>" class="nav-link active badge-notif"><strong>
                            <?= $d->nm_distribusi ?>
                        </strong></a>
                <?php endif ?>
            <?php else : ?>
                ...
                <?php else : ?>
                    <a href="<?= route('head', ['id' => $d->id_distribusi]) ?>" data-badge="<?= $d->jumlah ?>" class="nav-link badge-notif"><strong>
                            <?= $d->nm_distribusi ?>
                        </strong></a>
                <?php endif ?>
            <?php endif ?>
    ...
    <?php if ($id == '4') : ?>
        ...
        <?php else : ?>
            <li class="nav-item">
                <a href="<?= route('head', ['id' => '4']) ?>" data-badge="{{$distribusi_food->qty}}" class="nav-link badge-notif active"><strong>Food
                    </strong></a>
            </li>
        <?php endif ?>
    ...
    <?php else : ?>
        ...
        <?php else : ?>
            <li class="nav-item">
                <a href="<?= route('head', ['id' => '4']) ?>" class="nav-link badge-notif " data-badge="{{$distribusi_food->qty}}"><strong>Food
                    </strong></a>
            </li>
        <?php endif ?>
