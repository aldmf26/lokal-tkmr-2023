        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="float-left">Jurnal Pengeluaran</h5>
              <a href="" data-toggle="modal" data-target="#viewtgl" class="btn btn-new btn-sm float-right mr-1"><i
                  class="fas fa-eye"></i> View</a>
              <a href="" data-toggle="modal" data-target="#tambsah" class="btn btn-new btn-sm float-right mr-1"><i
                  class="fas fa-file-export"></i> Export
              </a>
              <a href="" data-toggle="modal" data-target="#tambah" class="btn btn-new btn-sm float-right mr-1"><i
                  class="fas fa-plus"></i>
                Pengeluaran</a>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <table class="table table-striped dataTable no-footer" id="table" role="grid"
                      ...
                      <thead>
                        @php
                        $tDebit = DB::table('tb_jurnal')->where([['id_lokasi',
                        Request::get('acc')],['id_buku',3]])->sum('debit');
                        $tKredit = DB::table('tb_jurnal')->where([['id_lokasi',
                        Request::get('acc')],['id_buku',3]])->sum('kredit');
                        @endphp
                        <tr role="row">
                          <th>No</th>
                          <th>Tanggal</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="{{ route('deletejPengeluaran', ['kd_gabungan' => $a->kd_gabungan,'id_lokasi' => Request::get('acc')]) }}"
                              onclick="return confirm('Apakah ingin dihapus ?')"
                              class="btn btn-sm btn-outline-secondary"><i class="fa fa-trash"></i></a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
...
<form action="{{ route('jPengeluaran', ['acc' => Request::get('acc')]) }}" method="get">
  <div class="modal fade" id="viewtgl" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
          ...
          <div id="atk" class="detail">
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <label for="list_kategori">Qty</label>
                  <input type="text" class="form-control input_detail input_atk qty_monitoring1" qty=1 name="qty[]"
                    required>
                </div>
              </div>
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <label for="list_kategori">Total Rp</label>
                  <input type="text" class="form-control  input_detail input_atk total_rp total_rp1" name="ttl_rp[]"
                    total_rp='1' required>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select name="id_penanggung[]" class="form-control select2 satuan input_detail input_peralatan"
                    required>
                    <option>--Pilih penanggung jawab--</option>
                    <?php foreach ($nm_penanggung as $n) : ?>
                    <option value="<?= $n->id_penanggung ?>">
                      <?= $n->nm_penanggung ?>
                    </option>
                    <?php endforeach; ?>
                  </select>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select name="id_lokasi[]" class="form-control select2 satuan input_detail input_peralatan" required>
                    <option selected value="{{Request::get('acc') == 1 ? '1' : '2'}}" disabled>{{Request::get('acc') ==
                      1 ? 'TAKEMORI' : 'SOONDOBU'}}</option>
                  </select>
                </div>
              </div>
              <div class="col-md-2">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <label for="list_kategori">Qty</label>
                  <input type="text" class="form-control input_detail input_peralatan qty_monitoring1" qty=1
                    name="qty[]" required>
                </div>
              </div>
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <label for="list_kategori">Total Rp</label>
                  <input type="text" class="form-control  input_detail input_peralatan total_rp total_rp1"
          ...
          <div id="aktiva" class="detail">
            ...
            <div class="row">
              ...
              <div class="col-md-1">
                <div class="form-group">
                  <label for="list_kategori">Qty</label>
                  <input type="text" class="form-control input_detail input_aktiva qty_aktiva qty_monitoring1"
                    name="qty" id="txt3" onkeyup="sum();" value="1" required>
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
                  <label for="list_kategori">Rp/Satuan</label>
                  <input type="text" name="rp_satuan"
                    class="form-control ttlp total_penyesuaian rp_satuan_aktiva  input_detail input_aktiva " id="ttlp"
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control input_detail total_rp_new1 input_aktiva total_rp_new"
                    name="ppn" id="txt2" onkeyup="sum();">
                </div>
              </div>
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control total_penyesuaian  input_detail input_aktiva pajak_aktiva"
                    id="total2" name="ttl_rp" required>
                </div>
              </div>
            </div>
  ...
  function sum()
        {
          ...
          var input3 = document.getElementById('txt3').va lue;
