        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="float-left">Jurnal Pemasukan </h5>
              <a href="" data-toggle="modal" data-target="#view" class="btn btn-info btn-sm float-right mr-1"><i
                  class="fas fa-eye"></i> View</a>
              <a href="" data-toggle="modal" data-target="#tambsah" class="btn btn-info btn-sm float-right mr-1"><i
                  class="fas fa-file-export"></i> Export
              </a>
              <a href="" data-toggle="modal" data-target="#tambah" class="btn btn-info btn-sm float-right mr-1"><i
                  class="fas fa-plus"></i>
                Pemasukan</a>
            </div>
            <div class="card-body">
              <div id="table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                <div class="row">
                  <div class="col-lg-12">
                    <table class="table  dataTable no-footer" id="example2" role="grid" aria-describedby="table_info">
                      <thead>
                        <tr>
                          <th>No</th>
                          <th>Tanggal</th>
                          ...
                          <th>Nama Akun</th>
                          @php
                          $tDebit = DB::table('tb_jurnal')->where('id_lokasi', Request::get('acc'))->sum('debit');
                          $tKredit = DB::table('tb_jurnal')->where('id_lokasi', Request::get('acc'))->sum('kredit');
                          @endphp
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="{{ route('delJpem') }}" class="btn btn-sm btn-outline-secondary"><i
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row justify-content-end">
          ...
          <div class="col-md-1">
            <button type="button" id="tambah_debit_pengeluaran" class="btn btn-sm btn-success"><i
        ...
        <div class="row justify-content-end">
          ...
          <div class="col-md-1">
            <button type="button" id="tambah_kredit_pengeluaran" class="btn btn-sm btn-success"><i
                class="fas fa-plus-square"></i></button>
          </div>
        </div>
